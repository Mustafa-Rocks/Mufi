...
$c=0;
$rcount = mysqli_query($conn,"SELECT * FROM item WHERE category = '$cat' ");
...
$result = mysqli_query($conn,"SELECT * FROM item WHERE category = '$cat' ");
...
<!-- Sidebar end=============================================== -->
	...
	<h3> <?php echo "$cat";      ?> <small class="pull-right"> <?php  echo "$c";       ?> products are available </small></h3>	
	<hr class="soft"/>
	<p>
