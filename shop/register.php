...
<script>
            function validation() {
                var username =
                    document.forms.add.username.value;
                var fname =
                    document.forms.add.fname.value;
                var lname =
                    document.forms.add.lname.value;
                ...
                var city =
                    document.forms.add.city.value;
                var state=
                    document.forms.add.state.value;
                var country =
                    document.forms.add.country.value;
                var zip =
                    document.forms.add.zip.value;
        ...
        <div class="authentication-inner">
          <!-- Register Card -->
            ...
            <div class="card-body ">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">FrostWood</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Adventure starts here 🚀</h4>
              <p class="mb-4">Register!The first step towards starting your adventure</p>

              <form name="add"  id="formAuthentication"  onsubmit="return validation()"   class="mb-3"  method="POST">
                <div class="mb-3">
            ...
            <?php
                ...
                $zip = $_POST['zip'];
                $sql="INSERT INTO user(fname,lname,username, password,email,contact,address,city,state,country,zip) VALUES('$fname', '$lname' , '$uname' ,  '$password' ,'$email' ,'$contact' ,'$address' ,'$city' ,'$state' ,'$country' ,'$zip'  )";
